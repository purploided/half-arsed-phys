...
function ShowOn() {
    ...
    setTimeout(() => { document.getElementById("collisionChecker").style.left = "10%"; }, 300);

    document.getElementById("orbitOn").style.display = "block";
    setTimeout(() => { document.getElementById("orbitOn").style.left = "20%"; }, 300);

    document.getElementById("crashOn").style.display = "block";
    setTimeout(() => { document.getElementById("crashOn").style.left = "30%"; }, 300);

    document.getElementById("susOn").style.display = "block";
    setTimeout(() => { document.getElementById("susOn").style.left = "40%"; }, 300);
